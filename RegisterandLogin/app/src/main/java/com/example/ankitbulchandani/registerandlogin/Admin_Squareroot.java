...
public class Admin_Squareroot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin__average);
        db = openOrCreateDatabase("questions_info", MODE_PRIVATE, null);
        db.execSQL("create table IF NOT EXISTS Squareroot(Questions varchar(100) PRIMARY KEY,"
                + "Option_1 varchar(50),"
                + "Option_2 varchar(50),"
                + "Option_3 varchar(50),"
                + "Option_4  varchar(50),"
