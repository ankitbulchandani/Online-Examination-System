...
public class Admin_Ratio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("create table IF NOT EXISTS Ratio(Questions varchar(100) PRIMARY KEY,"
                + "Option_1 varchar(50),"
                + "Option_2 varchar(50),"
                + "Option_3 varchar(50),"
                + "Option_4  varchar(50),"
