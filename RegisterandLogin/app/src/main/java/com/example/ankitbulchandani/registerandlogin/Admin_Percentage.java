...
public class Admin_Percentage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("create table IF NOT EXISTS Percentage(Questions varchar(100) PRIMARY KEY,"
                + "Option_1 varchar(50),"
                + "Option_2 varchar(50),"
                + "Option_3 varchar(50),"
                + "Option_4  varchar(50),"
